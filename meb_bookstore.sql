...
--
-- Host: localhost
-- Generation Time: Mar 07, 2023 at 06:59 PM
...
(39, 'nitid', '23', 2, '2023-03-08 08:56:15');
...
('sans', 'bone@mail.com', '123', '', '', 'user', 1),
('tear', '123@123.com', '123', '', '', 'user', 1);
...
ALTER TABLE `cart`
  ...
  ADD CONSTRAINT `cart_ibfk_2` FOREIGN KEY (`username`) REFERENCES `user` (`username`);
