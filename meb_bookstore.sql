...
(39, 'เกิดชาตินี้พี่ต้องเทพ เล่ม 5 - (Mushoku Tensei)', 'Rifujin na Magonote', 'https://cdn-local.mebmarket.com/meb/server1/92889/Thumbnail/book_detail_large.gif?5', 0, '2023-03-01 04:09:08', '\"ในที่สุดพวกรูเดียสก็เดินทางมาถึง ‘ทวีปมิลิส’ อันเป็นแผ่นดินของมนุษย์และจุดเชื่อมสู่ทวีปกลาง ที่นั่นรูเดียสได้พบกับ ‘เปาโล’ พ่อของเขาหลังจากไม่ได้พบหน้ากันถึงห้าปี แต่เปาโลในเวลานี้กลับเปลี่ยนไปราวกับคนละคน เกิดอะไรขึ้นในช่วงที่ไม่ได้พบกัน? หนำซ้ำพวกเขายังมีเรื่องทะเลาะกันใหญ่โตแบบนี้แล้วความสัมพันธ์ของสองพ่อลูกจะกลับมาเป็นเหมือนเดิมได้หรือไม่...\nเรื่องราวของชายหนุ่มวัย 34 ผู้ไม่เอาไหนซึ่งกลับชาติมาเกิดใหม่ในโลกแห่งเวทมนตร์และคมดาบ มาถึงเล่มที่ 5 แล้ว!\"', 0, 259),
(42, 'คำคมฟลอปป้า', 'Floppa', 'https://i.kym-cdn.com/entries/icons/original/000/034/421/cover1.jpg', 5, '2023-03-22 12:29:13', 'ถึงอ้ายจะแบด แต่อ้ายไม่เคยเบียวแซดให้คุณสนใจหรอกนะ', 3, 990);
...
(42, 'test1', 'อย่างดี', 5, '2023-03-22 14:37:44');
...
('adray', '1231231231231231', 'Nitid Dewsurin', '04', 2023, '3123', 'DEWSURIN', '2023-03-22', '2023-03-22');
...
('adray', 'adray@hentai.com', '123', 'adray', 'adray', 'admin', 'https://cdn.donmai.us/original/62/01/__hoshimachi_suisei_hololive_drawn_by_ixy__620116171d6d4a7538a2e92280501cff.jpg', 1),
('chok', 'chok@gmail.com', '123', 'Chokky', 'krub', 'user', '0', 1),
('dre', 'dre@gmail.com', '123', 'mike', 'e', 'user', '0', 0),
('nitid', 'nitid1987@gmail.com', '123', 'nitid', 'dewsurin', 'user', '0', 0),
('nonlnwza', 'nathanon969@gmail.com', '123', 'non', 'lnwza', 'admin', '0', 0),
('test1', 'test1@email.com', '321', 'test', 'tester', 'user', 'https://i.scdn.co/image/ab67616d0000b273fce23dadb51975ebf2e9d75c', 0);
...
--
ALTER TABLE `book`
  ADD CONSTRAINT `book_ibfk_1` FOREIGN KEY (`category`) REFERENCES `category` (`categoryId`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `favorite`
  ...
  ADD CONSTRAINT `favorite_ibfk_2` FOREIGN KEY (`username`) REFERENCES `user` (`username`) ON DELETE CASCADE ON UPDATE CASCADE;
